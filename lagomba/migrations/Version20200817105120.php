 ...
 */
final class Version20200817105120 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE `order` ADD user_id INT DEFAULT NULL, DROP user_id_id');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE `order` ADD user_id_id INT NOT NULL, DROP user_id');
